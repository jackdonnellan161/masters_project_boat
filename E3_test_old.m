function E3 = E3_test_old(U_field,V_field)
    ...
    up_costs = cellfun(@(x,y) -(x*y)+1,uv_cell_array,up_cell_array,...
        'UniformOutput',false);
    down_costs = cellfun(@(x,y) -(x*y)+1,uv_cell_array,down_cell_array,...
        'UniformOutput',false);
    left_costs = cellfun(@(x,y) -(x*y)+1,uv_cell_array,left_cell_array,...
        'UniformOutput',false);
    right_costs = cellfun(@(x,y) -(x*y)+1,uv_cell_array,right_cell_array,...
        'UniformOutput',false);
    up_right_costs = cellfun(@(x,y) (-(x*y)+1)*sqrt(2),uv_cell_array,up_right_cell_array,...
        'UniformOutput',false);
    up_left_costs = cellfun(@(x,y) (-(x*y)+1)*sqrt(2),uv_cell_array,up_left_cell_array,...
        'UniformOutput',false);
    down_right_costs = cellfun(@(x,y) (-(x*y)+1)*sqrt(2),uv_cell_array,down_right_cell_array,...
        'UniformOutput',false);
    down_left_costs = cellfun(@(x,y) (-(x*y)+1)*sqrt(2),uv_cell_array,down_left_cell_array,...
        'UniformOutput',false);
